...
import FilteredFilmCardList from './filtered-film-card-list';
...
describe('FilteredFilmCardList component test', () => {
  it('should render correctly', () => {
    const count = 4;
    const store = mockStore({ films: { films: makeFakeFilmList(count) } });
